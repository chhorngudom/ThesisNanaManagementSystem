...
Public Class Reportallemployee
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ThesisNanaManagementSystem.Reportallemployee.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportallemployee
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reportallemployee = New Reportallemployee()
        rpt.Site = Me.Site
        Return rpt
    End Function
