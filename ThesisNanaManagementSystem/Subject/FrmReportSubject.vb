...
Public Class FrmReportSubject
    Dim cry As New ReportDocument
    Dim connection As New SqlConnection(ClsConnection.ConnectDb)
    Private Sub CrystalReportViewer1_Load(sender As Object, e As EventArgs) Handles CrystalReportViewer1.Load
        cry.Load("C:\Users\Chhorng Udom\Documents\Visual Studio 2015\Projects\ThesisNanaManagementSystem\ThesisNanaManagementSystem\Subject\CrystalReport1.rpt")
