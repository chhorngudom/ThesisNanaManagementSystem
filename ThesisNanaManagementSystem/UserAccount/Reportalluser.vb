...
Public Class Reportalluser
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ThesisNanaManagementSystem.Reportalluser.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportalluser
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reportalluser = New Reportalluser()
        rpt.Site = Me.Site
        Return rpt
    End Function
