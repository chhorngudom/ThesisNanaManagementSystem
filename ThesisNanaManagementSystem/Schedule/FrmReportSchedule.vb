...
Public Class FrmReportSchedule
    ...
    Private Sub FrmReportSchedule_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub CrystalReportViewer1_Load(sender As Object, e As EventArgs) Handles CrystalReportViewer1.Load
        cry.Load("C:\Users\Chhorng Udom\Documents\Visual Studio 2015\Projects\ThesisNanaManagementSystem\ThesisNanaManagementSystem\Schedule\ReportSchedule.rpt")
